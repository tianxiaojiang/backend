/**
 ...
 @Author：贤心
 @License：MIT
 @Extend by: https://github.com/yelog/layui-select-multiple
 */
        ...
        var that = this
            ...
            select: function(){
                var TIPS = '请选择', CLASS = 'layui-form-select', TITLE = 'layui-select-title'
                    ...
                    //选择
                    var omit = typeof select.attr("lay-omit") === 'undefined'; // 简写为 已选择x项
                        ...
                        if(typeof select.attr('multiple') && typeof select.attr('multiple') === 'string'){
                            ...
                            if(othis.find("input[type='checkbox']").is(':checked')){
                                if (omit) {
                                    ...
                                    input.eq(0).val("已选择 " + othis.parent().find('[type=checkbox]:checked').length + " 项");
                                }
                                valueStr.push(value);
                            }else{
                                if (omit) {
                ...
                selects.each(function(index, select){
                    ...
                    //替代元素
                    var inputValue =  !(typeof $(select).attr("lay-omit") === 'undefined') && value != null && value.length > 0 ? '已选择 ' + value.length + " 项" : "";
                    if(typeof othis.attr('multiple') && typeof othis.attr('multiple') === 'string') {
                                ...
                                layui.each(options, function (index, item) {
                                    if (index === 0 && !item.value) {
                                        ...
                                        if (index ===1 && isSearchInput) {
                                            // 限制最大高度，防止高度溢出弹层
                                            arr.push('<div  style="max-height: 174px; overflow-y: auto" >')                                            
