...
layui.define(['laytpl', 'layer', 'ztutil'], function(exports){
  ...
  view.exit = function(){
    ...
    //跳转到登入页
    location.href = setter.integration_url;
  ...
  view.req = function(options){
    ...
    //查看是否有权限
    view.getHasPrivilege = function (privileges, callback) {
        if(!ztutil.isArray(privileges) || privileges.length < 1) {
